...
[test-image]: https://github.com/stdlib-js/number-float16-base-from-word/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/number-float16-base-from-word/actions/workflows/test.yml?query=branch:main
